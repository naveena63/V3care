...
public class HorizontalPicker extends LinearLayout implements HorizontalPickerListener {
    ...
    private int days;
    private int offset;
    private int mDateSelectedColor = 0;
    ...
    public void init() {
        ...
        tvMonth.setTextColor(mMonthAndYearTextColor != -1 ? mMonthAndYearTextColor : getColor(R.color.white));
        tvToday.setVisibility(showTodayButton ? VISIBLE : INVISIBLE);
        tvToday.setTextColor(mTodayButtonTextColor != -1 ? mTodayButtonTextColor : getColor(R.color.white));
        ...
        mDateSelectedColor = mDateSelectedColor == -1 ? getColor(R.color.white) : mDateSelectedColor;
        mDateSelectedTextColor = mDateSelectedTextColor == -1 ? Color.WHITE : mDateSelectedTextColor;
        mTodayDateTextColor = mTodayDateTextColor == -1 ? getColor(R.color.white) : mTodayDateTextColor;
        mDayOfWeekTextColor = mDayOfWeekTextColor == -1 ? getColor(R.color.white) : mDayOfWeekTextColor;
