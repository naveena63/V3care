...
import com.app.ashesha.v3care.Cart.Increment_Listener;
import com.app.ashesha.v3care.Packages.PackageModel;
...
Toolbar toolbar;
    ...
    public void onDateSelected(DateTime dateSelected) {
        try {
            ...
            prefManager.setDate(selectedDate);
            getAvailableSlot();
